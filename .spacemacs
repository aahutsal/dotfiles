...
you should place your code here."
  ...
  (use-package org-projectile
    ...
    :config
    (progn
      (setq org-projectile-projects-directory "~/dev")
  ...
  (use-package nodejs-repl
    :ensure t
    :hook (js-mode-hook js2-mode-hook)
    :bind (
  ...
  ;; (add-to-list 'load-path "/home/archer/xelb")
  ;; (add-to-list 'load-path "/home/gutsalarsen/.emacs.d/elpa/exwm-0.24/")
  ;; (require 'exwm)
  ;; (require 'exwm-config)
  ;; (exwm-config-example)
