...
you should place your code here."
  ...
  ;; Setting exec-path
  (setq exec-path (append exec-path '("~/.config/nvm/versions/node/v14.15.0/bin")))
  ...
  (use-package ts-comint
    :ensure t
    :config (add-hook 'typscript-mode-hook
                      (lambda ()
